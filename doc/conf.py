# -*- coding: utf-8 -*-
#
# pyl2extra documentation build configuration file
# It is based on pylearn2 (and Theano) documentation build
#
...
project = 'Pyl2Extra'
copyright = '2015, Nicu Tofan'

# A list of glob-style patterns that should be excluded when
# looking for source files.
exclude_patterns = ['pylearn2/*', 'html/*']
