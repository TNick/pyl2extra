...
class TestParamStore(unittest.TestCase):
    ...
    def test_seq_all(self):
        ...
        self.assertListEqual(rslt, ['white', 1])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['red', 2])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['green', 3])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['blue', 1])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['black', 2])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['white', 3])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['red', 1])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['green', 2])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['blue', 3])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['black', 1])
    ...
    def test_seq_one(self):
        ...
        self.assertListEqual(rslt, ['white', 1])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['white', 2])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['red', 2])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['red', 3])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['green', 3])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['green', 1])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['blue', 1])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['blue', 2])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['black', 2])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['black', 3])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['white', 3])
        rslt = self.testee.next()
        self.assertListEqual(rslt, ['white', 1])
